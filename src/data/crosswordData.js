...
export const crosswordData = {
  words: [
    // Orizzontali
    { word: "MARTINGARRIX", clue: "Questo è stato il peggior dj del nameless", direction: "horizontal" },
    ...
    { word: "SEMPRE", clue: "Il sesso migliore fatto", direction: "horizontal" },
    { word: "DOLLARAMA", clue: "Il tuo negozio preferito in Canada", direction: "horizontal" },
    { word: "INSALATA", clue: "Verdura che più mi fa schifo", direction: "horizontal" },
    { word: "FOREVER", clue: "La serie tv cringe che stiamo guardando", direction: "horizontal" },
    { word: "ALIBI", clue: "La prima canzone di cui abbiamo parlato", direction: "horizontal" },
    { word: "SETTE", clue: "Che giorno di maggio 2024 siamo andati a teatro", direction: "horizontal" },
    { word: "ANNALISA", clue: "La prima cantante al nameless che abbiamo visto assieme", direction: "horizontal" },
    ...
    { word: "PIEMONTE", clue: "Nome della pizza più buona che ho mai mangiato", direction: "vertical" },
    ...
    { word: "PALESTRA", clue: "Il tuo sport preferito", direction: "vertical" },
    { word: "BURLA", clue: "Nome del posto in cui abbiamo fatto un aperitivo con un milione di zanzare", direction: "vertical" },
    { word: "MARRONE", clue: "Il tuo colore preferito di vestiti", direction: "vertical" },
    { word: "PALLAVOLO", clue: "Sport che tu odi praticare", direction: "vertical" },
