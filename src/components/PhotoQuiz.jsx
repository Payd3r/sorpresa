...
const PhotoQuiz = () => {
  ...
  const getImageClassName = (index) => {
    let baseClass = "w-full h-60 object-cover rounded-lg cursor-pointer transition-all duration-300 transform hover:scale-105 ";
              ...
              `}>
                ...
                <p className={`font-semibold ${
                  ...
                  {isCorrect 
                    ...
                    : `Era ${question.options[question.correctAnswer]}! NCS fra!`
                  }
                </p>
              </div>
            )}
